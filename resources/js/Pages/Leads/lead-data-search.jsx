...
export const LeadDataSearch = () => {
    const [inputValue, setValue] = useState(""); // For the search input
    ...
    const handleClear = () => {
        ...
        useUpdateSearchParam({ search: "", page: 1, per_page: 50 }, "/lead"); // Clear the search param
    };
